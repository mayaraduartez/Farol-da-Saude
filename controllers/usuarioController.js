...
async function salvaravdae(req, res) {
  ...
  const depressaoScore = (perg3 + perg5 + perg10 + perg13 + perg16 + perg17 + perg21) * 2;
  const ansiedadeScore = (perg2 + perg4 + perg7 + perg9 + perg15 + perg19 + perg20) * 2;
  const estresseScore = (perg1 + perg6 + perg8 + perg11 + perg12 + perg14 + perg18) * 2;
